        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <tbody>
            ...
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="__APP__/User/userdel/id/<?php echo ($vo["id"]); ?>" title="删除此用户"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除此用户" /></a>
                 <a href="__APP__/User/userup/id/<?php echo ($vo["id"]); ?>" title="修改此用户详细信息"><img src="__PUBLIC__/Admin/Images/icons/hammer_screwdriver.png" alt="修改此用户详细信息" /></a> </td>
