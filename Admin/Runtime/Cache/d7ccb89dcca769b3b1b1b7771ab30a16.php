...
<body>
  ...
  <div id="main-content">
          ...
          <table>
            <thead>
              <tr>
                <th colspan="2">
        <!--判断action开始-->
            	<?php if($_GET['action']== 'add'): ?><form action="__URL__/addTypedq" method="post">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="__URL__/typemanagedq">添加根级分类</a>
			</form>
	<?php elseif($_GET['action']== 'upname'): ?>
			<form action="__URL__/upnamedq" method="post">
	...
	<?php else: ?> 
			<form action="__URL__/addroottypedq" method="post">
        ...
        <!--判断action结束-->
          ...
          <tbody>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="__URL__/typemanagedq/action/add/id/<?php echo ($vo["id"]); ?>/path/<?php echo ($vo["newpath"]); ?>/typename/<?php echo ($vo["typename"]); ?>" title="添加子类别"><img src="__PUBLIC__/Admin/Images/icons/pencil.png" alt="添加子类别" /></a> 
                  <a href="__URL__/deltypedq/id/<?php echo ($vo["id"]); ?>" title="删除子类别"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除子类别" /></a>
                 <a href="__URL__/typemanagedq/action/upname/id/<?php echo ($vo["id"]); ?>/typename/<?php echo ($vo["typename"]); ?>" title="修改类别名称"><img src="__PUBLIC__/Admin/Images/icons/hammer_screwdriver.png" alt="修改类别名称" /></a> </td>
