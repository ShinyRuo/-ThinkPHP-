        ...
        <div class="tab-content default-tab" id="tab1">
            ...
            <tfoot>
              <tr>
                <td colspan="3">
                  ...
                  <div class="pagination"> 分页<?php echo ($page); ?> </div>
                  <!-- End .pagination -->
                  <div class="clear"></div>
                </td>
              </tr>
          ...
          <tbody>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                <td><?php echo (mb_strcut($vo["title"],0,24,"utf-8")); ?></td>
                <td><?php echo (mb_strcut($vo["content"],0,39,"utf-8")); ?>……</td>
                <td>
                  <!-- Icons -->
                   <a href="__APP__/Notice/upnotice/id/<?php echo ($vo["id"]); ?>" title="修改公告"><img src="__PUBLIC__/Admin/Images/icons/hammer_screwdriver.png" alt="修改公告" /></a>
                  <a href="__APP__/Notice/delnotice/id/<?php echo ($vo["id"]); ?>" title="删除公告"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除公告" /></a>
                 </td>
