...
function setDefaultMenu(val) {
	...
	<!-- Start current auction list -->
	<div class="container">
				<div class="tabview"><h2 class="title fl">即将竞拍</h2></div>
...
<!-- 				<div class="clearfix" id="filterTool">
				...
				<div class="content">
					...
					<table class="chart notice">
					  <tr>
					    <th scope="col" width="60">商品图片</th>
					    <th scope="col" width="15%">商品名称</th>
					    <th scope="col" width="15%">我的出价</th>
				...
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
					    <td align="center" height="67px" >
					    	<a href="">
								<img style="width:80px;height:60px;" src="__PUBLIC__/Uploads/pics/b_<?php echo ($vo["pic"]); ?>" alt="900金 魔兽世界三区灰谷" />
							</a>
					    </td>
