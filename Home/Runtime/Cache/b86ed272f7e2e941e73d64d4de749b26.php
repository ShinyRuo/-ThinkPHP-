...
function setDefaultMenu(val) {
	...
	<!-- Start current auction list -->
	<div class="container">
				<div class="tabview"><h2 class="title fl">竞拍历史</h2></div>
...
<!-- 				<div class="clearfix" id="filterTool">
				...
				<div class="content">
					...
					<table class="chart notice">
					  ...
					  <!-- start iterator -->
				<?php if(is_array($auctionhistory)): foreach($auctionhistory as $key=>$vo): ?><tr>
					    ...
					    <td align="center">
						<?php if($vo['aumoney'] == $vo['auction'][0]['aumoney']): ?><span style='color:green'>成功拍取</span>
						<?php else: ?>
								<span style='color:#C31A1F;'>竞拍失败</span><?php endif; ?>
					    </td>
