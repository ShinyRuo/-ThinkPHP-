...
<div id="header" class="clearfix blueLink">
	...
	<div id="auctionDetail" class="mainbody clearfix">
		...
		<!-- #productList -->
		<div id="productList" class="container clearfix">
	
			<div class="tabview">
				<h2 class="title fl">即将推出的商品</h2>
			</div>
			...
			<div class="content">
				...
				<th width="36%" class="tc">开拍时间</th>
				</tr>
				<!--Start: iterator  -->
				
				<?php if(is_array($future)): foreach($future as $key=>$vo): ?><tr class="AuctionHOR">
							<td>
								<div class="proImg">
									<a>
