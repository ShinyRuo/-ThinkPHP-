...
function setDefaultMenu(val) {
	...
	<!-- Start current auction list -->
	<div class="container">
				<div class="tabview"><h2 class="title fl">正在竞拍</h2></div>
				...
				<div class="content">
					...
					<table class="chart notice">
					  <tr>
					    ...
					    <th scope="col" width="12%">商品名称</th>
					    <th scope="col" width="12%">被拍次数</th>
					    <th scope="col" width="12%">我的出价</th>

					    <th scope="col" width="12%">现在价格 </th>
					    <th scope="col" width="22%">结束时间 </th>
					    <th scope="col">拍卖状态 </th>
					  </tr>
					  
					   <tr><td colspan="8">&nbsp;</td></tr>
					 
					  <!-- start iterator -->
				<?php if(is_array($auctioning)): foreach($auctioning as $key=>$vo): ?><tr>
					    ...
					    <td align="center" class="price">
							<span id="price_58373" title="被拍次数"><?php echo ($vo["autimes"]); ?></span>
					    </td>
					    
					    <td align="center">
							<span style="color:#C31A1F;" id="end_count_58373"><?php echo ($vo["aumoney"]); ?></span>
					    </td>
					    				    
					    
					    <td align="center" style="color:#C31A1F;">
							<?php echo ($vo["auction"]["0"]["aumoney"]); ?>
					    </td>
					    ...
					    <td align="center">
						<?php if($vo['aumoney'] == $vo['auction'][0]['aumoney']): ?><span style='color:#C31A1F;'>你是最高价</span>
						<?php else: ?>
								<span style='color:#C31A1F;'><a href="__APP__/Index/info/id/<?php echo ($vo["id"]); ?>">继续竞拍</a></span><?php endif; ?>
					    </td>
