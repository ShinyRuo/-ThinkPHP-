...
function setDefaultMenu(val) {
	...
	<!-- Start current auction list -->
	<div class="container" >
				<div class="tabview"><h2 class="title fl">订单管理</h2></div>
				
				<!-- div class="clearfix" id="filterTool" style="margin:10px 5px 0px 10px;">
					<form name="searchForm" action="/app/homepage/orderlist">
						<select class="select space fl" name="orderStatus" id="type">
						...
						<input type="submit" class="sendReq" value="筛选" />
					</form>
				</div> -->
				...
				<div class="content">
					...
					<table class="chart notice">
					  <tr>
					    <th scope="col" width="10">商品图片</th>
					    <th scope="col" width="10%">商品名称</th>
					    <th scope="col" width="25%">订单号</th>
					    <th scope="col" width="10%">买家</th>
					    <th scope="col" width="10%">成交价格 </th>
					    <th scope="col" width="22%">成交时间 </th>
				...
				<?php if(is_array($orderlist)): foreach($orderlist as $key=>$vo): ?><tr>
					    ...
					    <td align="center" class="price">
							<span id="price_58373" title="订单号"><?php echo ($vo["onum"]); ?></span>
					    </td>
					    
					    <td align="center">
							<span style="color:#C31A1F;" id="end_count_58373"><?php echo ($vo["buyername"]); ?></span>
					    </td>
					    ...
					    <td align="center">
							<?php if($vo["ostatus"] ==1): ?>已发货
							<?php else: ?>
							<form action="__URL__/deal" method="post" name="myForm<?php echo ($vo["id"]); ?>">
								<input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>">
								<input type="hidden" name="total" value="<?php echo ($vo["total"]); ?>">
								<input type="hidden" name="buyer" value="<?php echo ($vo["buyername"]); ?>">
							</form>
							<button style="color:red;" title="点击发货" id="submit<?php echo ($vo["id"]); ?>">发货</button><?php endif; ?>
							
									<script>
										$(function(){
											$('#submit<?php echo ($vo["id"]); ?>').click(function(){			
												if(confirm('确定发货么？')){
													$('form[name="myForm<?php echo ($vo["id"]); ?>"]').submit();
												}
											});
										});
								</script>
