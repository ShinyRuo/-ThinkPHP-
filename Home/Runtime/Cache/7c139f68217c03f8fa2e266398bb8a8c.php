...
function setDefaultMenu(val) {
	...
	<!-- Start current auction list -->
	<div class="container" >
				<div class="tabview"><h2 class="title fl">我的购买</h2></div>
...
<!-- 				<div class="clearfix" id="filterTool" style="margin:10px 5px 0px 10px;">
				...
				<?php if(is_array($orderlist)): foreach($orderlist as $key=>$vo): ?><tr>
					    ...
					    <td align="center" class="price">
							<span id="price_58373" title="市场价"><?php echo ($vo["onum"]); ?></span>
					    </td>
					    
					    <td align="center">
							<span style="color:#C31A1F;" id="end_count_58373"><?php echo ($vo["sellername"]); ?></span>
					    </td>
					    ...
					    <td align="center">
							<?php if($vo["ostatus"] ==1): ?><span style="color:green">已发货</span>
							<?php else: ?><span style="color:red">未发货</span><?php endif; ?>
					    </td>
